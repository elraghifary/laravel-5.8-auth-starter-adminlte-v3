        ...
        foreach ($users as $key => $user) {
            ...
            $output['data'][$i][] = '
                <form action="' . $link_delete . '" method="post" class="form-delete">
                    <a href="' . $link_role . '" class="btn btn-info btn-xs" data-popup="tooltip" title="Set User Role"><i class="fas fa-user-secret"></i></a>
                    <a href="' . $link_show . '" class="btn btn-default btn-xs" data-popup="tooltip" title="View User"><i class="fas fa-eye"></i></a>
                    <a href="' . $link_edit . '" class="btn btn-warning btn-xs" data-popup="tooltip" title="Edit User"><i class="fas fa-edit"></i></a>
                    <input type="hidden" name="_token" value="' . csrf_token() . '">
                    <input type="hidden" name="_method" value="DELETE">
                    <button class="btn btn-danger btn-xs" data-popup="tooltip" title="Delete User"><i class="fas fa-trash"></i></button>
                </form>';
            $i++;
        }
